<%@ Page Title="Reporte Empleado No Registrado" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ReporteEmpleadoNoRegistrado.aspx.cs" Inherits="Asistencia.Reporte.ReporteEmpleadoNoRegistrado" %>
            ...
            <div class="box box-default">
                <div class="box-header with-border">
                    <div class="user-block">
                        <span class="username">Reporte de Empleado No Registrado</span>
                    </div>
                </div>
                <div class="box-body">
